...
// if (compteurminutes === 0) {// si la saisie de l'internaute est strictement égale à lundi
//     document.write("demain nous serons mardi!");
// } else if (compteurminutes === "mardi") {
//     document.write("demain nous serons mercredi!");
// } else if (compteurminutes === "mercredi") {
//     document.write("demain nous serons jeudi!");
// } else if (compteurminutes === "jeudi") {
//     document.write("demain nous serons vendredi!");
// } else if (compteurminutes === "vendredi") {
//     document.write("demain nous serons samedi!");
// } else if (compteurminutes === "samedi") {
//     document.write("demain nous serons dimanche!");
// } else if (compteurminutes === "dimanche") {
//     document.write("demain nous serons lundi!");
// } else if (compteurminutes === "lundi") {
//     document.write("demain nous serons mardi!");
// } else {
